...
//   return (
//     <section className="relative py-10 overflow-hidden bg-gradient-to-b from-gray-900 via-black to-gray-900">
//       {/* Background Elements */}
...
//         <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-1 bg-gradient-to-r from-transparent via-[#B03982]/20 to-transparent"></div>
//       </div>
...
//               <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/30 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 md:p-8">
//                 <p className="text-lg text-gray-300 leading-relaxed">
//                   <span className="font-bold text-white">NerdyBuddy</span> is not just a chatbot. It's a{' '}
...
//                     </span>
//                     <span className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-[#B03982]/20 to-[#733C86]/20 -z-10"></span>
//                   </span>{' '}
//                   built to help employees interact with complex organizational knowledge{' '}
//                   <span className="font-bold text-white">quickly, safely, and intelligently</span> —
...
//                       <div
//                         key={index}
//                         className="group bg-gradient-to-br from-gray-800/30 to-gray-900/20 backdrop-blur-sm rounded-xl border border-gray-700/30 p-5 hover:border-[#B03982]/50 transition-all duration-300 hover:scale-[1.02]"
//                       >
//                         <div className="flex items-start gap-4">
//                           <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-lg group-hover:from-[#B03982]/30 group-hover:to-[#733C86]/30 transition-all duration-300">
...
//                       <div
//                         key={index}
//                         className="group flex items-center gap-4 p-4 bg-gradient-to-br from-gray-800/30 to-gray-900/20 backdrop-blur-sm rounded-xl border border-gray-700/30 hover:border-[#B03982]/50 transition-all duration-300"
//                       >
//                         <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-lg group-hover:from-[#B03982]/30 group-hover:to-[#733C86]/30 transition-all duration-300">
//                           <CheckCircle className="w-5 h-5 text-[#B03982] group-hover:text-white transition-colors duration-300" />
//                         </div>
//                         <div className="flex-1">
//                           <h5 className="font-semibold text-white">{item.title}</h5>
//                           <p className="text-sm text-gray-400 mt-1">{item.description}</p>
//                         </div>
//                         <ArrowRight className="w-5 h-5 text-gray-500 group-hover:text-[#B03982] transition-colors duration-300" />
//                       </div>
//                     ))}
//                   </div>
//                 </div>
...
//               <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/30 backdrop-blur-sm rounded-xl border border-gray-700/30 p-4 text-center">
//                 <div className="text-2xl font-bold bg-gradient-to-r from-[#B03982] to-[#733C86] bg-clip-text text-transparent">
//                   10x
//                 </div>
//                 <div className="text-sm text-gray-400 mt-1">Faster Access</div>
//               </div>
//               <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/30 backdrop-blur-sm rounded-xl border border-gray-700/30 p-4 text-center">
//                 <div className="text-2xl font-bold bg-gradient-to-r from-[#B03982] to-[#733C86] bg-clip-text text-transparent">
//                   99%
...
//             {/* Security Badge */}
//             <div className="mt-6 flex items-center justify-center gap-3 p-4 bg-gradient-to-br from-gray-800/30 to-gray-900/20 backdrop-blur-sm rounded-xl border border-gray-700/30">
//               <Lock className="w-5 h-5 text-[#B03982]" />
//               <div>
//                 <span className="text-sm font-medium text-white">Enterprise-Grade Security</span>
//                 <p className="text-xs text-gray-400">End-to-end encrypted knowledge base</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//               description: "Adapts to your organization's terminology",
//               icon: <Brain className="w-6 h-6" />
//             },
//             {
//               title: "Multi-Format Support",
//               description: "PDFs, Docs, Slides, and more",
//               icon: <FileText className="w-6 h-6" />
//             },
//             {
//               title: "Real-time Updates",
//               description: "Always current with your latest knowledge",
//               icon: <Zap className="w-6 h-6" />
//             }
//           ].map((feature, index) => (
//             <div
//               key={index}
//               className="group p-6 bg-gradient-to-br from-gray-800/20 to-gray-900/10 backdrop-blur-sm rounded-2xl border border-gray-700/20 hover:border-[#B03982]/50 transition-all duration-300 hover:scale-[1.02]"
//             >
//               <div className="flex items-start gap-4">
//                 <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-xl group-hover:from-[#B03982]/20 group-hover:to-[#733C86]/20 transition-all duration-300">
