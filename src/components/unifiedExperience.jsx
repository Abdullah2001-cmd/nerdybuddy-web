...
//   const platformStats = [
//     { value: "100%", label: "Sync Across All Devices", icon: <Zap className="w-4 h-4" />, color: "text-orange-500" },
//     { value: "24/7", label: "Availability", icon: <Cpu className="w-4 h-4" />, color: "text-blue-500" },
//     { value: "Enterprise", label: "Security Level", icon: <ShieldCheck className="w-4 h-4" />, color: "text-green-500" },
//     { value: "Unified", label: "User Experience", icon: <Users className="w-4 h-4" />, color: "text-purple-500" }
//   ];
...
//   return (
//     <section className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
...
//           {/* Left Column - Image */}
//           <div className="relative">
//             {/* Main Image Container - Light */}
//             <div className="relative rounded-3xl overflow-hidden shadow-xl group">
//               {/* Gradient Border - Light */}
//               <div className="absolute -inset-1 bg-gradient-to-br from-[#B03982]/10 via-transparent to-[#733C86]/10 rounded-3xl opacity-30 blur group-hover:opacity-50 transition-opacity duration-500"></div>
...
//                 <div className="absolute inset-0 bg-gradient-to-t from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
...
//                         </div>
//                         <div>
//                           <p className="text-sm font-medium text-gray-800">Multi-Platform AI Interface</p>
//                           <p className="text-xs text-gray-600 mt-1">Seamless experience across all devices</p>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//               <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-tl-3xl"></div>
//               <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-br-3xl"></div>
//             </div>

//             {/* Platform Icons Bar - Light */}
//             <div className="mt-8 flex items-center justify-center gap-4">
//               {[
//                 { icon: <Globe className="w-5 h-5" />, label: "Web" },
//                 { icon: <SmartphoneIcon className="w-4 h-4" />, label: "iOS" },
//                 { icon: <MonitorIcon className="w-4 h-4" />, label: "Android" },
//                 { icon: <Shield className="w-4 h-4" />, label: "Kiosk" }
//               ].map((item, index) => (
//                 <div
//                   key={index}
//                   className="flex flex-col items-center gap-2 p-3 bg-white rounded-xl border border-gray-200 shadow-sm group hover:border-[#B03982]/40 transition-all duration-300"
//                 >
...
//             {/* Header - Light */}
//             <div className="space-y-4">
//               <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#B03982]/5 to-[#733C86]/5 rounded-full border border-[#B03982]/20">
//                 <Sparkles className="w-4 h-4 text-[#B03982]" />
...
//               <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
//                 <span className="block text-gray-900">Unified Experience</span>
//                 <span className="block mt-2 bg-gradient-to-r from-[#B03982] via-[#a32c8d] to-[#733C86] bg-clip-text text-transparent">
//                   Across Platforms
//                 </span>
//               </h2>
...
//             {/* Experience Qualities - Light */}
//             <div className="space-y-4">
//               <div className="grid grid-cols-2 gap-4">
//                 {experienceQualities.slice(0, 2).map((quality, index) => (
//                   <div
//                     key={index}
//                     className="group relative bg-white rounded-xl border border-gray-200 p-4 hover:border-[#B03982]/40 hover:shadow-md transition-all duration-300"
//                   >
//                     <div className="flex items-center gap-3">
//                       <div className={`flex-shrink-0 w-10 h-10 flex items-center justify-center ${quality.bgColor} rounded-lg group-hover:scale-110 transition-all duration-300`}>
//                         <div className={quality.color}>
//                           {quality.icon}
//                         </div>
//                       </div>
//                       <div>
//                         <h4 className="font-semibold text-gray-900">{quality.title}</h4>
...
//             {/* App Store Icons - Light */}
//             <div className="flex items-center justify-center gap-6 pt-6">
//               {/* Apple App Store Icon */}
//               <div className="group relative">
//                 <div className="absolute -inset-2 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
//                 <div className="relative w-32 h-10 flex items-center justify-center bg-white rounded-xl border border-gray-300 group-hover:border-[#B03982]/40 transition-all duration-300">
//                   <div className="flex items-center gap-2">
//                     <svg className="w-6 h-6 text-gray-800" viewBox="0 -189.93 539.856 539.856" fill="currentColor">
//                       <path d="M134.032 35.268a3.83 3.83 0 0 1-3.834 3.83H4.729a3.835 3.835 0 0 1-3.839-3.83V4.725A3.84 3.84 0 0 1 4.729.89h125.468a3.834 3.834 0 0 1 3.834 3.835l.001 30.543z"/>
//                       <path d="M30.128 19.784c-.029-3.223 2.639-4.791 2.761-4.864-1.511-2.203-3.853-2.504-4.676-2.528-1.967-.207-3.875 1.177-4.877 1.177-1.022 0-2.565-1.157-4.228-1.123-2.14.033-4.142 1.272-5.24 3.196-2.266 3.923-.576 9.688 1.595 12.859 1.086 1.554 2.355 3.287 4.016 3.226 1.625-.066 2.232-1.035 4.193-1.035 1.943 0 2.513 1.035 4.207.996 1.744-.027 2.842-1.56 3.89-3.127 1.255-1.779 1.759-3.533 1.779-3.623-.04-.014-3.386-1.292-3.42-5.154zM26.928 10.306c.874-1.093 1.472-2.58 1.306-4.089-1.265.056-2.847.875-3.758 1.944-.806.942-1.526 2.486-1.34 3.938 1.421.106 2.88-.717 3.792-1.793z"/>
//                     </svg>
//                     <div className="text-left">
...
//                 <div className="relative w-32 h-10 flex items-center justify-center bg-white rounded-xl border border-gray-300 group-hover:border-[#B03982]/40 transition-all duration-300">
//                   <div className="flex items-center gap-2">
//                     <svg className="w-5 h-5 text-gray-800" viewBox="0 -47.5 135 135" fill="currentColor">
//                       <path d="M10.4 7.5c-.3.3-.4.8-.4 1.4V31c0 .6.2 1.1.5 1.4l.1.1L23 20.1v-.2L10.4 7.5z"/>
//                       <path d="M27 24.3l-4.1-4.1V19.9l4.1-4.1.1.1 4.9 2.8c1.4.8 1.4 2.1 0 2.9l-5 2.7z"/>
//                       <path d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4"/>
//                       <path d="M27.1 15.8L12.5 7.5c-.9-.5-1.6-.4-2.1.1L22.9 20l4.2-4.2z"/>
...
//         {/* Platform Details - Light */}
//         <div className="mt-16 grid md:grid-cols-3 gap-8">
//           {platforms.map((platform, index) => (
//             <div
//               key={index}
//               className="group relative bg-white rounded-2xl border border-gray-200 p-6 hover:border-[#B03982]/40 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
//             >
...
//                   <div className={`relative w-14 h-14 flex items-center justify-center ${platform.bgColor} rounded-xl border border-gray-200 group-hover:border-transparent transition-all duration-300`}>
//                     <div className={`${platform.color} transform group-hover:scale-110 transition-transform duration-300`}>
//                       {platform.icon}
//                     </div>
//                   </div>
//                 </div>
...
//                     <div 
//                       className={`h-full bg-gradient-to-r ${platform.color.replace('text', 'from')} ${platform.color} rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
//                     ></div>
//                   </div>
//                 </div>
//               </div>
...
//         {/* Unified Experience Message - Light */}
//         <div className="mt-12 text-center">
//           <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-[#B03982]/5 to-[#733C86]/5 rounded-full border border-[#B03982]/20">
//             <Layers className="w-5 h-5 text-[#B03982]" />
...
//       <div className="absolute top-32 right-10 hidden lg:block">
//         <div className="w-20 h-20 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full border border-[#B03982]/10 backdrop-blur-sm"></div>
//       </div>
      
//       <div className="absolute bottom-32 left-10 hidden lg:block">
//         <div className="w-24 h-24 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full border border-[#B03982]/10 backdrop-blur-sm"></div>
//       </div>
//     </section>
//   );
// };
