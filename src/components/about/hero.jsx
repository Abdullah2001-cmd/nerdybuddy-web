    ...
    <section className="relative pt-44 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16">
            ...
            <div className="relative group">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-xl border border-gray-200 p-4 hover:border-[#B03982]/50 transition-all duration-300 hover:shadow-lg group"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white rounded-lg border border-gray-200">
                ...
                {milestones.map((milestone, index) => (
                  <div key={index} className="relative pl-12">
                    <div className="absolute left-0 top-1">
                      <div className="w-12 h-12 flex items-center justify-center bg-white rounded-full border-4 border-white shadow-lg">
                        <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[#B03982] to-[#733C86]"></div>
                      </div>
                    </div>
          ...
          <div className="space-y-8">
            {/* Introduction Card */}
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-xl">
                      <Rocket className="w-6 h-6 text-[#B03982]" />
                    </div>
                  </div>
                  <div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {values.map((value, index) => (
                  <div
                    key={index}
                    className="group relative bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg transition-all duration-300"
                  >
                    {/* Corner Accent */}
                    ...
                    <div className="space-y-3 relative">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 flex items-center justify-center bg-gradient-to-br ${value.color} bg-opacity-10 rounded-lg`}>
                          <div className={`text-transparent bg-gradient-to-br ${value.color} bg-clip-text`}>
                            {value.icon}
                          </div>
                        </div>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Nerdy Buddy</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-center gap-3">
                    <div className="w-5 h-5 flex items-center justify-center bg-gradient-to-br from-emerald-100 to-green-100 rounded-full">
