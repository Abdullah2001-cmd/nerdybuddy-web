...
//         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-full blur-3xl"></div>
//         <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-full blur-3xl"></div>
...
//             <div
//               key={index}
//               className="bg-gradient-to-br from-gray-800/30 to-gray-900/20 backdrop-blur-sm rounded-xl border border-gray-700/30 p-6 text-center group hover:border-[#B03982]/50 transition-all duration-300 hover:scale-105"
//             >
//               <div className={`text-3xl md:text-4xl font-bold mb-2 ${stat.color}`}>
//                 {stat.value}
//               </div>
//               <div className="text-sm text-gray-400">{stat.label}</div>
//               <div className="mt-3 h-1 w-16 mx-auto bg-gradient-to-r from-gray-700 to-gray-600 rounded-full overflow-hidden">
//                 <div 
...
//             <div
//               key={index}
//               className="group relative bg-gradient-to-br from-gray-800/20 to-gray-900/10 backdrop-blur-sm rounded-2xl border border-gray-700/30 p-8 hover:border-[#B03982]/50 transition-all duration-300 hover:scale-[1.02]"
//             >
//               {/* Animated Background */}
...
//                     <div className="relative w-16 h-16 flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-gray-700/50 group-hover:border-transparent transition-all duration-300">
...
//                   <h3 className="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-[#B03982] group-hover:to-[#733C86] group-hover:bg-clip-text transition-all duration-300">
//                     {problem.title}
//                   </h3>
...
//                       <span className="text-sm font-medium text-gray-300">{problem.stats}</span>
//                       <div className="w-8 h-1 bg-gradient-to-r from-gray-700 to-gray-600 rounded-full overflow-hidden">
...
//                 {/* Number Badge */}
//                 <div className="absolute -top-3 -left-3 w-10 h-10 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black rounded-full border border-gray-700 text-sm font-bold text-gray-400 group-hover:text-white group-hover:bg-gradient-to-r group-hover:from-[#B03982] group-hover:to-[#733C86] transition-all duration-300">
//                   {index + 1}
//                 </div>
//               </div>
//             </div>
...
//                     <div className="flex items-center justify-between">
//                       <span className="text-sm font-medium text-gray-300">{problem.stats}</span>
//                       <div className="w-24 h-2 bg-gradient-to-r from-gray-700 to-gray-600 rounded-full overflow-hidden">
...
//                 {/* Number Badge */}
//                 <div className="absolute -top-3 -right-3 w-10 h-10 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black rounded-full border border-gray-700 text-sm font-bold text-gray-400 group-hover:text-white group-hover:bg-gradient-to-r group-hover:from-[#B03982] group-hover:to-[#733C86] transition-all duration-300">
//                   {index + 4}
//                 </div>
//               </div>
//             </div>
...
//         {/* Impact Summary */}
//         <div className="mt-16 bg-gradient-to-br from-gray-800/30 to-gray-900/20 backdrop-blur-sm rounded-2xl border border-gray-700/30 p-8">
...
//                 <span className="text-white font-medium">Productivity Loss</span>
//               </div>
//               <div className="flex items-center gap-3">
//                 <BarChart3 className="w-5 h-5 text-[#B03982]" />
//                 <span className="text-white font-medium">Increased Costs</span>
//               </div>
//               <div className="flex items-center gap-3">
//                 <Users className="w-5 h-5 text-[#B03982]" />
//                 <span className="text-white font-medium">Employee Turnover</span>
//               </div>
//             </div>
//           </div>
...
//             </div>
//             <div className="w-full h-3 bg-gradient-to-r from-gray-800 to-gray-700 rounded-full overflow-hidden">
...
//           </p>
//           <button className="group relative px-8 py-4 bg-gradient-to-br from-[#B03982] to-[#733C86] rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#B03982]/30">
...
//         <div className="w-24 h-24 bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-full border border-[#B03982]/20 backdrop-blur-sm animate-pulse"></div>
//       </div>
      
//       <div className="absolute bottom-20 right-10 hidden lg:block">
//         <div className="w-32 h-32 bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10 rounded-full border border-[#B03982]/20 backdrop-blur-sm animate-pulse animation-delay-1000"></div>
//       </div>
...
const ProblemStatement = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full blur-3xl"></div>
