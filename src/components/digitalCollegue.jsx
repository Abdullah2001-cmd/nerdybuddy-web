...
//   return (
//     <section className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
//       {/* Animated Background Elements */}
//       <div className="absolute inset-0 overflow-hidden">
//         {/* Gradient Orbs */}
//         <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
//         <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-[#B03982]/20 to-[#733C86]/20 rounded-full blur-3xl translate-x-1/2 translate-y-1/2 animate-pulse animation-delay-1000"></div>
...
//           <div
//             key={i}
//             className="absolute w-1 h-1 bg-gradient-to-br from-[#B03982] to-[#733C86] rounded-full animate-float-particles"
//             style={{
...
//                   {/* Animated Overlay */}
//                   <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end">
...
//                           </div>
//                           <div>
//                             <p className="text-sm font-medium text-white">Processing AI Response...</p>
//                             <p className="text-xs text-gray-400 mt-1">Real-time knowledge retrieval</p>
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
//                 <span className="block text-white">Meet your new</span>
//                 <span className="block mt-2">
//                   <span className="relative">
//                     <span className="relative z-10 bg-gradient-to-r from-[#B03982] via-[#a32c8d] to-[#733C86] bg-clip-text text-transparent">
//                       Digital Colleague
//                     </span>
//                     <span className="absolute -bottom-2 left-0 w-full h-3 bg-gradient-to-r from-[#B03982]/20 to-[#733C86]/20 blur-xl -z-10"></span>
//                   </span>
//                 </span>
//               </h2>
...
//                 <div
//                   key={index}
//                   className="group relative bg-gradient-to-br from-gray-800/20 to-gray-900/10 backdrop-blur-sm rounded-2xl border border-gray-700/30 p-5 hover:border-[#B03982]/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#B03982]/10"
//                   style={{
...
//                     <div className="relative">
//                       <div className="absolute -inset-3 bg-gradient-to-br from-[#B03982] to-[#733C86] rounded-full blur opacity-0 group-hover:opacity-30 transition-opacity duration-500"></div>
...
//                       <h3 className="font-semibold text-white mb-2 leading-relaxed">
//                         {benefit.title}
//                       </h3>
...
//                           <div 
//                             className={`h-full bg-gradient-to-r ${benefit.gradient} rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left`}
//                           ></div>
//                         </div>
//                       </div>
//                     </div>
...
//                   {/* Floating Number */}
//                   <div className="absolute -left-3 -top-3 w-8 h-8 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black rounded-full border border-gray-700 text-xs font-bold text-gray-400 group-hover:text-white group-hover:border-[#B03982] transition-all duration-300">
//                     {index + 1}
//                   </div>
//                 </div>
//               ))}
...
//         <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/30 backdrop-blur-sm rounded-2xl border border-gray-700/30 p-4 transform rotate-3 hover:rotate-0 transition-transform duration-300">
...
//             100%
//           </div>
//           <div className="text-sm text-gray-400">Secure Data</div>
//         </div>
//       </div>
...
// export default DigitalColleague;
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-[#B03982]/5 to-[#733C86]/5 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
        ...
        {[...Array(10)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-gradient-to-br from-[#B03982]/30 to-[#733C86]/30 rounded-full animate-float-particles"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              animationDelay: `${Math.random() * 3}s`,
