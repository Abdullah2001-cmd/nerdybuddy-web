 ...
 * -----------------------------------
 * A comprehensive two‑block layout plus metrics section.
 * Fully converted from the provided Elementor HTML to a premium,
 * responsive React + Tailwind component, following the exact
 * UI/UX design language of the "About Nerdy Buddy" reference.
 *
 * Includes:
 *  – Block 1: Corporate Teams (hero left: text + video)
 *  – Block 2: Document Understanding (image left + features)
 *  – Block 3: KPI Counters (82% / 98% with descriptions)
 *  – Background: geometric grid, gradient blobs, soft shadows
...
const NerdyBuddyCorporate = () => {
  ...
  // ---------- Simple counter animation (optional, progressive) ----------
  useEffect(() => {
  ...
  const documentFeatures = [
    {
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          />
          <defs>
            <linearGradient id="gradient-star" x1="0.687988" y1="7.97043" x2="15.3122" y2="7.97043">
      ...
      text: "Startup to Enterprise Friendly",
    },
    {
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path
            d="M8.00008 15.3121C7.87786 15.3121 7.75897 15.2722 7.66141 15.1986C7.56384 15.125 7.4929 15.0216 7.45933 14.9041L6.87508 12.8588C6.62393 11.969 6.14875 11.1585 5.49497 10.5047C4.84119 9.85092 4.03065 9.37575 3.14083 9.12459L1.09558 8.54034C0.978137 8.5067 0.874836 8.43573 0.8013 8.33817C0.727763 8.24061 0.687988 8.12176 0.687988 7.99959C0.687988 7.87742 0.727763 7.75858 0.8013 7.66102C0.874836 7.56346 0.978137 7.49249 1.09558 7.45884L3.14083 6.87459C4.03065 6.62344 4.84119 6.14826 5.49497 5.49448C6.14875 4.8407 6.62393 4.03017 6.87508 3.14034L7.45933 1.09509C7.49298 0.977648 7.56394 0.874348 7.6615 0.800812C7.75906 0.727275 7.87791 0.6875 8.00008 0.6875C8.12225 0.6875 8.2411 0.727275 8.33866 0.800812C8.43622 0.874348 8.50719 0.977648 8.54083 1.09509L9.12508 3.14034C9.37624 4.03017 9.85141 4.8407 10.5052 5.49448C11.159 6.14826 11.9695 6.62344 12.8593 6.87459L14.9046 7.45884C15.022 7.49249 15.1253 7.56346 15.1989 7.66102C15.2724 7.75858 15.3122 7.87742 15.3122 7.99959C15.3122 8.12176 15.2724 8.24061 15.1989 8.33817C15.1253 8.43573 15.022 8.5067 14.9046 8.54034L12.8593 9.12459C11.9695 9.37575 11.159 9.85092 10.5052 10.5047C9.85141 11.1585 9.37624 11.969 9.12508 12.8588L8.54083 14.9041C8.50726 15.0216 8.43633 15.125 8.33876 15.1986C8.24119 15.2722 8.12231 15.3121 8.00008 15.3121Z"
            fill="url(#gradient-star2)"
          />
          <defs>
            <linearGradient id="gradient-star2" x1="0.687988" y1="7.97043" x2="15.3122" y2="7.97043">
              <stop stopColor="#7512A2" />
              <stop offset="0.485331" stopColor="#FF31AB" />
              <stop offset="1" stopColor="#FF6F05" />
            </linearGradient>
      ...
      text: "Secure & Compliant AI Engine",
    },
    {
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path
            d="M8.00008 15.3121C7.87786 15.3121 7.75897 15.2722 7.66141 15.1986C7.56384 15.125 7.4929 15.0216 7.45933 14.9041L6.87508 12.8588C6.62393 11.969 6.14875 11.1585 5.49497 10.5047C4.84119 9.85092 4.03065 9.37575 3.14083 9.12459L1.09558 8.54034C0.978137 8.5067 0.874836 8.43573 0.8013 8.33817C0.727763 8.24061 0.687988 8.12176 0.687988 7.99959C0.687988 7.87742 0.727763 7.75858 0.8013 7.66102C0.874836 7.56346 0.978137 7.49249 1.09558 7.45884L3.14083 6.87459C4.03065 6.62344 4.84119 6.14826 5.49497 5.49448C6.14875 4.8407 6.62393 4.03017 6.87508 3.14034L7.45933 1.09509C7.49298 0.977648 7.56394 0.874348 7.6615 0.800812C7.75906 0.727275 7.87791 0.6875 8.00008 0.6875C8.12225 0.6875 8.2411 0.727275 8.33866 0.800812C8.43622 0.874348 8.50719 0.977648 8.54083 1.09509L9.12508 3.14034C9.37624 4.03017 9.85141 4.8407 10.5052 5.49448C11.159 6.14826 11.9695 6.62344 12.8593 6.87459L14.9046 7.45884C15.022 7.49249 15.1253 7.56346 15.1989 7.66102C15.2724 7.75858 15.3122 7.87742 15.3122 7.99959C15.3122 8.12176 15.2724 8.24061 15.1989 8.33817C15.1253 8.43573 15.022 8.5067 14.9046 8.54034L12.8593 9.12459C11.9695 9.37575 11.159 9.85092 10.5052 10.5047C9.85141 11.1585 9.37624 11.969 9.12508 12.8588L8.54083 14.9041C8.50726 15.0216 8.43633 15.125 8.33876 15.1986C8.24119 15.2722 8.12231 15.3121 8.00008 15.3121Z"
            fill="url(#gradient-star3)"
          />
          <defs>
            <linearGradient id="gradient-star3" x1="0.687988" y1="7.97043" x2="15.3122" y2="7.97043">
              <stop stopColor="#7512A2" />
              <stop offset="0.485331" stopColor="#FF31AB" />
              <stop offset="1" stopColor="#FF6F05" />
            </linearGradient>
      ...
      text: "Cross-Document AI Linking",
    },
  ];

  return (
    <main ref={sectionRef} className="relative pt-[150px] pb-20 md:pb-28 lg:pb-32 overflow-hidden opacity-0 translate-y-8 transition-all duration-900 ease-out">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-gray-50/90 to-white">
        {/* Geometric pattern – signature grid */}
        <div className="absolute inset-0 opacity-[0.1]">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="corporate-grid-main" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#B03982" strokeWidth="1" opacity="0.25" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#corporate-grid-main)" />
          </svg>
        </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        {/* ========== BLOCK 1 – CORPORATE TEAMS (VIDEO LEFT / TEXT RIGHT?) – we keep original: heading left, video right ========== */}
        {/* BUT reference design: left visual / right text. We preserve original order: left text, right video (mirror of ref) – still elegant */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24 lg:mb-32">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200/80 shadow-md hover:shadow-lg transition-shadow">
              ...
              <span className="text-sm font-semibold text-gray-700">Corporate Teams</span>
            </div>
            ...
            {/* Description paragraph – exactly from original */}
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">
              Empower your internal teams with instant, AI-powered answers to frequently asked questions across HR, IT
              support, administrative procedures, and corporate policies — reducing HR workload and IT support tickets,
              while saving employees' time and improving productivity.
            </p>

            {/* subtle stat badges (optional, from original design language) */}
            <div className="flex flex-wrap gap-3 pt-2 justify-center lg:justify-start">
              <span className="inline-flex items-center gap-1.5 px-4 py-2 bg-white rounded-full border border-gray-200 text-sm font-medium text-gray-700 shadow-sm">
                <Zap className="w-4 h-4 text-[#B03982]" /> 70% faster answers
              </span>
              <span className="inline-flex items-center gap-1.5 px-4 py-2 bg-white rounded-full border border-gray-200 text-sm font-medium text-gray-700 shadow-sm">
                <Shield className="w-4 h-4 text-[#733C86]" /> Enterprise secure
              </span>
            </div>
          </div>

          {/* RIGHT COL – VIDEO (autoplay, loop, controls, nodownload) – premium container */}
          <div className="relative group">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-white/80 border border-gray-200/80 shadow-xl group-hover:shadow-2xl transition-all duration-500">
              <video
                ...
                src="https://nerdybuddy.com/wp-content/uploads/2025/07/corporate.mp4"
                autoPlay
                loop
                muted
                playsInline
        ...
        {/* ========== BLOCK 2 – ACCELERATE TEAM EFFICIENCY (IMAGE LEFT, FEATURES RIGHT) ========== */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24 lg:mb-32">
          {/* LEFT – IMAGE (full width, elegant) */}
          <div className="relative group order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden bg-white/80 border border-gray-200/80 shadow-xl group-hover:shadow-2xl transition-all duration-500">
              <img
                src="https://nerdybuddy.com/wp-content/uploads/2025/06/creativity-ideas-ai-artificial-intelligence-education-technology-concept-businesswomen-show-ai-light-bulb-icon-training-to-develop-new-skills-and-knowledge-ai-enhanced-learning-1024x683.jpg"
          ...
          {/* RIGHT – HEADING, DESC, FEATURE LIST */}
          <div className="space-y-6 order-1 lg:order-2 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200/80 shadow-sm">
              ...
              <span className="text-xs font-semibold text-gray-600">AI DOCUMENT UNDERSTANDING</span>
            </div>

            <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold leading">
              <span className="block">Accelerate Team</span>
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Nerdy Buddy transforms how corporate teams interact with documentation. Ask questions in natural language
              and get instant, accurate answers — no more reading through lengthy documentation or searching endless
              folders.
            </p>

            {/* Feature list – exactly 3 items with original star icon and gradient */}
            <div className="pt-4 flex flex-col items-center lg:items-start space-y-4">
            ...
            {/* Optional small CTA / tagline */}
            <div className="pt-6">
              <span className="text-sm text-gray-500 flex items-center gap-2 justify-center lg:justify-start">
                <CheckCircle className="w-4 h-4 text-emerald-600" /> Trusted by 100+ enterprises
              </span>
            </div>
          </div>
        </div>

        {/* ========== BLOCK 3 – COUNTERS / METRICS (82% High Accuracy, 98% Better Collaboration) ========== */}
        <div
          ref={counterRef}
            ...
            <div className="text-center space-y-4">
              <div className="flex justify-center">
                <span className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10">
                  <Award className="w-8 h-8 text-[#B03982]" />
                </span>
              </div>
              <div className="flex items-center justify-center gap-1">
                <span className="counter-value text-5xl md:text-6xl font-bold bg-gradient-to-r from-[#B03982] to-[#733C86] bg-clip-text text-transparent" data-target="82">
                  1
                </span>
                <span className="text-5xl md:text-6xl font-bold text-gray-900">%</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900">High Accuracy</h3>
              <p className="text-gray-600 max-w-xs mx-auto">
                Our AI provides context-aware, reference-backed answers.
              </p>
            </div>

            {/* Counter 2: 98% Better Collaboration */}
            <div className="text-center space-y-4">
              <div className="flex justify-center">
                <span className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#B03982]/10 to-[#733C86]/10">
                  <TrendingUp className="w-8 h-8 text-[#733C86]" />
                </span>
              </div>
              <div className="flex items-center justify-center gap-1">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Better Collaboration</h3>
              <p className="text-gray-600 max-w-xs mx-auto">
                Nerdy Buddy improves transparency and information flow between teams.
              </p>
            </div>
          </div>
...
export default NerdyBuddyCorporate;